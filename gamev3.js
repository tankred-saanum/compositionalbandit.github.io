...
export default class Game{
    constructor(ref){
        ...
        this.sliderWarningColor = this.totalRewardTextColor;
        this.sliderWarningTextSize = this.totalRewardTextSize;
        this.sliderWarningTop = this.GAME_WIDTH/2
        this.sliderWarning = new TextBox(this, this.sliderWarningTop, this.GAME_HEIGHT*0.2,
             `You need to move at least one slider before you can serve the food.`, "center", this.sliderWarningTextSize, false, this.sliderWarningColor);
        this.miscText.push(this.sliderWarning);
        ...
        this.colorInputDims = [this.xColorIdx, this.yColorIdx];
    ...
    loadImages(){
        ...
        this.allIngredients = [];
        this.colorOrdering = ["red", "blue"];
        this.xColorIdx = getRandomInt(0, 1);
        this.yColorIdx = 1 - this.xColorIdx;
        this.xIngredientColor = this.colorOrdering[this.xColorIdx];
        this.yIngredientColor = this.colorOrdering[this.yColorIdx];


        this.ingredientArray = [1, 2, 3, 4, 5, 6, 7, 8];
        this.ingredientArray = shuffle(this.ingredientArray);
        ...
        for (let i = 0; i < this.totalCycles; i++){
            ...
            for (let k = 0; k <= 15; k++){
                ...
                this.yIngredientImgs[k].src = `${this.currentFolder}/${this.currentIngredientIdx}/${k}.png`
            }
            this.ingredientPair = [this.xIngredientImgs, this.yIngredientImgs];
            this.allIngredients.push(this.ingredientPair);
